...
public partial class TagsViewModel(ITagService tagService) : BaseViewModel("All Collections")
{
    ...
    private async Task Initialize()
    {
        try
        {
            ...
            Tags.Add(new Tag() { Name = allTagName, Color = "#ff00ff" });
    ...
    private async Task TagSelected(string? tagName)
    {
        ...
        await Shell.Current.GoToAsync($"//CollectableItemsPage{queryParams}");
    }
}
